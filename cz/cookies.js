...
(function(){
  ...
  function showBanner(){
    ...
    b.innerHTML='<div class="cb-in"><span>Používáme soubory cookie, aby stránka fungovala správně a — s vaším souhlasem — abychom analyzovali provoz a zlepšovali nabídku. Podrobnosti v <a href="zasady-ochrany-osobnich-udaju.html">Zásadách ochrany osobních údajů</a> a <a href="zasady-cookies.html">Zásadách cookies</a>.</span>'
      +'<span class="cb-btns"><button class="cb-ess" id="cb-ess">Pouze nezbytné</button><button class="cb-all" id="cb-all">Přijmout vše</button></span></div>';
