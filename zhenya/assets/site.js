...
(function(){
  const TYPES=[['balzamy','Бальзамы'],['dobavki','Добавки'],['geli','Гели и кремы'],['pasty','Зубные пасты'],['komplekty','Комплекты']];
  ...
  if(hdr&&page==='catalog'){hdr.outerHTML=SAMPLE+`
...
<header class="site light">
  <div class="wrap phdr">
    <a class="plogo" href="index.html"><img src="assets/logo.webp" alt=""><span>Центр Болотова<small>Продукция по рецептам академика Болотова</small></span></a>
...
<header class="site">
  <div class="wrap hdr">
    <a class="logo" href="index.html"><img src="assets/logo.webp" alt="">Центр Болотова</a>
...
<footer>
  ...
  <div class="wrap f-cols">
    <div><img class="flogo" src="assets/logo.webp" alt=""><p style="margin:0">Бальзам Болотова и продукция по рецептам академика Бориса Болотова. Официальный сайт производителя.</p></div>
...
<a class="chat" href="https://t.me/centr_bolotova" aria-label="Телеграм"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a8 8 0 0 1-11.6 7.1L4 20.5l1.4-5A8 8 0 1 1 21 12z"/></svg></a>`;}
  ...
  window.CB.card=p=>{
    ...
    <a class="img${alt?' has-alt':''}" href="#"><img class="main" src="assets/products/${p.id}.webp" alt="" loading="lazy">${alt?`<img class="alt" src="${alt}" alt="" loading="lazy">`:''}<span class="quick">Быстрый просмотр</span></a>
